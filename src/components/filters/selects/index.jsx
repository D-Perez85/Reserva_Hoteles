 ...
 */
function Select({list, id, filterRef, stateCountry, statePrice, stateRoom, stateIn, stateOut}){
    return(
 ...
 */
    function filterByCountry(e){
        ...
        .filter((value)=>{
            return e.target.value === "Todos" ? value : value.country === e.target.value
        })
        .filter((value) => {
 ...
 */
    function filterByPrice(e){
        ...
        .filter((value)=>{
            return e.target.value === "Todos" ? value : filterPrice(value.price) === e.target.value
        })
        .filter((value) => {
            return stateRoom === "Todos"
              ? value
 ...
 */
    function filterByRooms(e){
        ...
        .filter((value)=>{
            return e.target.value === "Todos" ? value : filterRoom(value.rooms) === e.target.value
        })
        .filter((value) => {
            return statePrice === "Todos"
              ? value
